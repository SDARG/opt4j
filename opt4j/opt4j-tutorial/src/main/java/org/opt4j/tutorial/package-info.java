 ...
 * </p>
 * <p>
 * The {@link org.opt4j.tutorial.helloworld} example is a simple problem which shows the implementation of the
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.tutorial.salesman} example implements the <a
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.tutorial.optimizer} example shows the implementation of a simple optimizer which uses the
 * {@link org.opt4j.operator.mutate.Mutate} operator.
 * </p>
 * <p>
 * The {@link org.opt4j.tutorial.operator} example shows how to add own {@link org.opt4j.core.optimizer.Operator}s for
