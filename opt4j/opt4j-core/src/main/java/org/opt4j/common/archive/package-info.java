 ...
 * <p>
 * The {@link org.opt4j.common.archive.AbstractArchive} provides common methods
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.common.archive.BoundedArchive} is an abstract class
 ...
 * <p>
 * The {@link org.opt4j.common.archive.UnboundedArchive} stores each found
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.common.archive.CrowdingArchive} uses the crowding
 * distance of NSGA2 to decide which {@link org.opt4j.core.Individual}s to drop
 * if the maximum size is reached.
 * </p>
 * <p>
 * The {@link org.opt4j.common.archive.AdaptiveGridArchive} uses an adaptive
 * grid to decide which {@link org.opt4j.core.Individual}s to drop.
 * </p>
 * <p>
 * The {@link org.opt4j.common.archive.PopulationArchive} just mirrors the
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.common.archive.DefaultArchive} defines the
 * implementation to use if no archive is specified using the
 * {@link org.opt4j.common.archive.ArchiveModule}. The default is the
 * {@link org.opt4j.common.archive.CrowdingArchive} with a maximum size of 100
 * {@link org.opt4j.core.Individual}s.
 * <h3>Modules</h3>
 * <p>
 * The {@link org.opt4j.common.archive.ArchiveModule} allows to select the
