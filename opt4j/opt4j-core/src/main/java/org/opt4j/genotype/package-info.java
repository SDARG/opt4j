 ...
 * {@link org.opt4j.genotype.CompositeGenotype} to assemble complex genotypes.
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.genotype.DoubleGenotype} and
 * {@link org.opt4j.genotype.IntegerGenotype} both can be bounded by an upper
 * and lower bound for each value. The corresponding bounds classes are the
 * {@link org.opt4j.genotype.DoubleBounds} and
 * {@link org.opt4j.genotype.IntegerBounds}. These bounds are passed in the
 * constructor of the {@link org.opt4j.genotype.DoubleGenotype} or
 * {@link org.opt4j.genotype.IntegerGenotype}, respectively.
 * </p>
 * <p>
 * By default, the {@link org.opt4j.genotype.BooleanGenotype}, the
 * {@link org.opt4j.genotype.DoubleGenotype}, and the
 * {@link org.opt4j.genotype.IntegerGenotype} are pure lists. This means, one
 * has to identify elements by their index. The classes
 * {@link org.opt4j.genotype.BooleanMapGenotype},
 ...
 * {@link org.opt4j.genotype.IntegerGenotype} such that the elements are encoded
 * as integer values.
 * </p>
 * <p>
 * The classes {@link org.opt4j.genotype.BooleanMapGenotype},
 * {@link org.opt4j.genotype.DoubleMapGenotype},
 * {@link org.opt4j.genotype.IntegerMapGenotype},
 * {@link org.opt4j.genotype.SelectGenotype}, and
 * {@link org.opt4j.genotype.SelectMapGenotype} are extended from
 * {@link org.opt4j.genotype.BooleanGenotype},
 * {@link org.opt4j.genotype.DoubleGenotype}, and
 * {@link org.opt4j.genotype.IntegerGenotype}, respectively. Therefore, the
 ...
 * {@link org.opt4j.genotype.MapGenotype} and
 * {@link org.opt4j.genotype.SelectGenotype} classes.
 * </p>
 * <p>
